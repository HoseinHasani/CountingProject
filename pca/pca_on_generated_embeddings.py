...
label_mode = "number"   # "type" or "number"
nrows, ncols = 7, 4
...
fig.suptitle(f"PCA of Generated Token Embeddings — Labeled by {label_mode.capitalize()}",
             fontsize=26, weight="bold", y=0.97)

plt.tight_layout()
plt.subplots_adjust(top=0.93, bottom=0.05, left=0.04, right=0.98)

out_name = f"layerwise_pca_llm_generated_responses_{label_mode}.pdf"
